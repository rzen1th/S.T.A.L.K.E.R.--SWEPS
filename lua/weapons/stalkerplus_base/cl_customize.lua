...
function SWEP:CreateCustomizeSelectMenu(panel, slottbl)
    ...
    bg.Paint = function(self2, w, h)
        ...
        surface.SetFont("STALKERPLUS_16")
    ...
    local atts = STALKERPLUS.GetAttsForCats(slottbl.Category or "")
    ...
    table.sort(atts, function(a, b)
        ...
        local atttbl_a = STALKERPLUS.GetAttTable(a)
        local atttbl_b = STALKERPLUS.GetAttTable(b)
